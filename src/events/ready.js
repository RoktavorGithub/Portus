    ...
    run: async (client) => {
        ...
        if (allContextMenus?.length > 0) console.log(t.bold.magenta.toFunction()("[ContextMenus] ") + t.bold.white.toFunction()(`Loaded ${allContextMenus.length} ContextMenus.`));
                ...
                try {
                    ...
                    console.log(t.bold.brightYellow.toFunction()("[PostgresSQL Database] ") + t.bold.green.toFunction()("ONLINE"));
                } catch (error) {
                    console.log(t.bold.bgBrightYellow.toFunction()("[PostgresSQL Database] ") + t.bold.red.toFunction()("ERROR") + error);
                }
    }
